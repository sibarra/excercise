...
describe Usercp::ProductsController do
  ...
  describe 'logged in' do
    ...
    describe 'create a new product' do
      it 'should allow to create new products' do
        post :create, product: FactoryGirl.attributes_for( :product )
        response.should redirect_to usercp_product_path( assigns( :product ) )
      end
    ...
    describe 'with existing product' do
      ...
      it 'should update and redirect' do
        ...
        response.should redirect_to( usercp_product_path( product ) )
