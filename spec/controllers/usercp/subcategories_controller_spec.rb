...
describe Usercp::SubcategoriesController do
  ...
  describe 'signed in' do
    ...
    describe 'new' do
      ...
      it 'should create a new subcategory' do
        ...
        response.should redirect_to usercp_category_subcategory_path( category.id, new_subcategory )
      end
    ...
    describe 'with existing category' do
      ...
      it 'updates and redirects to the subcategory' do
        ...
        response.should redirect_to usercp_category_subcategory_path( subcategory.category, subcategory )
